  ...
  return (
    <DirectionPage
      ...
      teacher={{
        ...
        role: "Викладач журналістики та мовлення",
        img: teacherImg,
        bio: "12 років у телевізійній і digital-журналістиці. Працював ведучим, продюсером і автором сюжетів. Вчить так, щоб після курсу людина могла самостійно зняти й змонтувати свій матеріал — і не соромитися його показати.",
      }}
