...
const Journalism = () => {
  ...
  return (
    <div>
      ...
      <WhoIsItFor
        heading="Хто приходить до нас"
        applyTo="/apply?direction=journalism"
        items={[
          { icon: "📺", label: "Майбутні телевізійники", desc: "Бачите себе частиною редакції та хочете працювати на реальному телеканалі.", result: "Кращі студенти отримують можливість працевлаштування на одеському телеканалі." },
          { icon: "🎤", label: "Обличчя в кадрі", desc: "Прагнете позбутися страху об'єктива та говорити на камеру впевнено й природно.", result: "Практика в кадрі з першого тижня." },
          { icon: "📰", label: "Шукачі історій", desc: "Хочете бути в центрі подій, брати інтерв'ю та знімати власні репортажі.", result: "Навчишся інтерв'ю, репортажу та розслідуванню." },
          { icon: "🌍", label: "Творці контенту", desc: "Створюєте відео для соцмереж і прагнете робити матеріал, що реально впливає на аудиторію.", result: "Отримаєш досвід реальних зйомок і повноцінне портфоліо." },
        ]}
      />
      ...
      <HowItWorks
        ...
        steps={[
          { title: "Практичні завдання", desc: "На кожному занятті — конкретна вправа, а не суха лекція." },
          { title: "Власний проєкт", desc: "Ви працюєте над власною темою з першого дня." },
          { title: "Регулярний фідбек", desc: "Зворотний зв'язок після кожного блоку — Ви чітко бачите свій прогрес." },
          { title: "Фінальна збірка сюжету", desc: "Разом розбираємо відзняте й доводимо матеріал до ефірної якості." },
          { title: "Готова робота", desc: "Наприкінці курсу Ви маєте готовий сюжет для портфоліо та реального застосування." },
        ]}
      />

      <SkillsList
        heading="Що Ви отримаєте на курсі"
        items={[
          { title: "Робота в кадрі", desc: "Від першої зйомки до повноцінного сюжету." },
          { title: "Інтерв'ю та репортаж", desc: "Як записувати коментарі, будувати матеріал і монтувати." },
          { title: "Кухня телеканалу", desc: "Редакція, ефіри, монтажна — зсередини й без ілюзій." },
          { title: "Реальні герої", desc: "Робота з живими людьми, подіями та проблемами міста." },
          { title: "Портфоліо", desc: "Якісні роботи для резюме та подальшого просування." },
          { title: "Рекомендації", desc: "Від практиків із 19-річним досвідом у медіа." },
        ]}
      />
