  ...
  return (
    <div>
      ...
      <WhoIsItFor
        ...
        items={[
          { icon: "💡", label: "Генератори ідей", desc: "Маєте крутий задум, але не знаєте, як перетворити його на повноцінний сценарій.", result: "Саме з цього починається курс — від ідеї до готового сценарію." },
          { icon: "✍️", label: "Абсолютні новачки", desc: "Ніколи не писали професійно, але дуже хочете навчитися створювати історії.", result: "Курс веде від основ до завершеного проєкту в портфоліо." },
          { icon: "🎭", label: "Практики кіно та театру", desc: "Актори й режисери, яким потрібно розуміти анатомію сюжету зсередини.", result: "Навчишся читати і будувати драматургію зсередини." },
          { icon: "📱", label: "Сторітелери", desc: "Працюєте з відео, соцмережами чи YouTube і хочете тримати увагу аудиторії.", result: "Сценарна логіка зробить твій контент сильнішим." },
        ]}
      />
